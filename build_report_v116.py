...
# ── Build document ─────────────────────────────────────────────────────────
out = "/home/user/workspace/AareML-report.pdf"  # v1.16
...
story.append(p(f"Report version: 1.16  ·  Last updated: {_now}", "meta"))
story.append(sp(32))
...
abstract_table = Table(
    [[Paragraph(
        ...
        "and evaluate its zero-shot transfer to 12 Swiss gauges (mean DO RMSE = 0.419 mg/L, 3.3\u00d7 lower RMSE than the LakeBeD-US LSTM reference; per-gauge retraining achieves 0.392 mg/L). "
        "A Wilcoxon signed-rank test across 11 gauges confirms a <b>statistically significant improvement (p=0.007)</b> "
        ...
        "Zero-shot application to 4 US rivers achieves mean RMSE of 1.292 mg/L, with the "
        "Willamette River (Oregon) well below the lake benchmark at 0.759 mg/L. "
        "A Swiss lake experiment (21 lakes, Bärenbold et al. 2026) confirms that "
        "zero-shot river\u2192lake transfer fails (RMSE = 2.811 mg/L, NSE = \u22122.723), "
...
story.append(p(
    ...
    "The 3-seed ensemble LSTM outperforms Ridge on <i>both</i> RMSE (0.300 vs 0.303 mg/L) and KGE (0.932 vs 0.908) simultaneously \u2014 "
    ...
    "At gauge 2473, the most meaningful difference is in KGE: the Optuna LSTM (0.932) "
...
all_model_data = [
    ...
    [p("LSTM (best Optuna)","table_cell"), p("DO (mg/L)","table_cell"), p("<b>0.300</b>","table_cell_c"),
     p("[0.268, 0.331]","table_cell_c"), p("0.235","table_cell_c"), p("0.891","table_cell_c"), p("<b>0.932</b>","table_cell_c")],
...
ms_data = [
    ...
    [p("2009","table_cell"), p("0.268","table_cell_c"), p("0.253","table_cell_c"), p("0.279","table_cell_c"), p("0.774","table_cell_c")],
    [p("2016","table_cell"), p("0.594","table_cell_c"), p("0.531","table_cell_c"), p("0.545","table_cell_c"), p("0.849","table_cell_c")],
    [p("2018","table_cell"), p("0.383","table_cell_c"), p("\u2014","table_cell_c"),     p("0.420","table_cell_c"), p("0.910","table_cell_c")],
    [p("2044","table_cell"), p("0.499","table_cell_c"), p("0.496","table_cell_c"), p("0.562","table_cell_c"), p("0.878","table_cell_c")],
    [p("2085","table_cell"), p("0.408","table_cell_c"), p("0.403","table_cell_c"), p("0.383","table_cell_c"), p("0.897","table_cell_c")],
    [p("2143","table_cell"), p("0.449","table_cell_c"), p("0.415","table_cell_c"), p("0.421","table_cell_c"), p("0.926","table_cell_c")],
    [p("2174","table_cell"), p("0.382","table_cell_c"), p("0.421","table_cell_c"), p("0.371","table_cell_c"), p("0.881","table_cell_c")],
    [p("2410","table_cell"), p("0.452","table_cell_c"), p("0.411","table_cell_c"), p("0.426","table_cell_c"), p("0.394","table_cell_c")],
    [p("2415","table_cell"), p("0.430","table_cell_c"), p("0.390","table_cell_c"), p("0.403","table_cell_c"), p("0.895","table_cell_c")],
    [p("2462","table_cell"), p("0.344","table_cell_c"), p("0.256","table_cell_c"), p("0.292","table_cell_c"), p("0.823","table_cell_c")],
    [p("2473","table_cell"), p("0.307","table_cell_c"), p("0.296","table_cell_c"), p("0.316","table_cell_c"), p("0.886","table_cell_c")],
    [p("2613","table_cell"), p("0.509","table_cell_c"), p("0.437","table_cell_c"), p("0.447","table_cell_c"), p("0.906","table_cell_c")],
    [p("<b>Mean (excl. 2473)</b>","table_cell"), p("<b>0.419</b>","table_cell_c"), p("<b>0.392</b>","table_cell_c"),
     p("<b>0.405</b>","table_cell_c"), p("<b>0.833</b>","table_cell_c")],
]
...
story.append(p(
    ...
    "EA-LSTM mean RMSE = 0.405 mg/L (11 gauges excluding 2473). "
...
story.append(p(
    ...
    "a mean DO RMSE of <b>0.419 mg/L</b> across 11 gauges (excl. training gauge 2473) \u2014 3.3\u00d7 better than the "
    "LakeBeD-US LSTM reference (1.40 mg/L). Per-gauge retraining improves this to "
    "<b>0.392 mg/L</b> (3.6\u00d7 better). The EA-LSTM achieves <b>0.405 mg/L</b>, incorporating static catchment attributes (elevation, "
...
story += highlight_new([p(
    ...
    "(p=0.007), while the per-gauge retrain difference is not statistically significant "
    ...
    "test. Gauge 2018, which lacks a Ridge baseline (per-gauge retrain also failed), is excluded from the Wilcoxon test, reducing to n=11 paired differences. The mean RMSE of 0.419 mg/L in Table 4 "
...
usgs_data = [
    ...
    [p("Willamette, OR", "table_cell"), p("0.759", "table_cell_c"), p("0.610", "table_cell_c"), p("0.823", "table_cell_c")],
    [p("Fox River, WI", "table_cell"), p("1.328", "table_cell_c"), p("0.595", "table_cell_c"), p("0.566", "table_cell_c")],
    [p("Mississippi, LA", "table_cell"), p("1.464", "table_cell_c"), p("0.300", "table_cell_c"), p("0.447", "table_cell_c")],
    [p("Missouri, MO", "table_cell"), p("1.617", "table_cell_c"), p("0.517", "table_cell_c"), p("0.467", "table_cell_c")],
    [p("<b>Mean</b>", "table_cell"), p("<b>1.292</b>", "table_cell_c"), p("<b>0.853</b>", "table_cell_c"), p("<b>0.611</b>", "table_cell_c")],
]
...
usgs_section_content.append(Paragraph(
    "Mean RMSE of 1.292 mg/L is substantially worse than Swiss zero-shot performance (0.419 mg/L), "
    "as expected given the complete absence of US training data. Nevertheless, the Willamette River "
    "(0.759 mg/L) approaches the LakeBeD-US LSTM reference (1.40 mg/L) \u2014 a Pacific Northwest "
    "river with alpine headwaters and a temperate climate similar to Swiss rivers. "
    "The Mississippi performs worst (RMSE 1.464, NSE 0.449), reflecting its large drainage area, "
...
swiss_lake_data = [
    ...
    [p("Zero-shot river\u2192lake transfer", "table_cell"),
     p("2.811", "table_cell_c"), p("\u22122.723", "table_cell_c"), p("\u22120.375", "table_cell_c")],
    ...
    [p("AareML LSTM (river, ref.)", "table_cell"),
     p("<b>0.300</b>", "table_cell_c"), p("0.891", "table_cell_c"), p("<b>0.932</b>", "table_cell_c")],
]
...
story.append(p(
    "<b>Zero-shot river\u2192lake transfer fails entirely</b> (RMSE = 2.811 mg/L, "
    "NSE = \u22122.723, KGE = \u22120.375). An NSE below zero means the transferred model performs "
...
story += highlight_new([p(
    ...
    "headwaters and temperate Pacific climate, achieves RMSE of 0.759 mg/L without any retraining — "
...
story.append(p(
    ...
    "Zero-shot transfer of the Swiss river LSTM to 21 Swiss lakes produces RMSE = 2.811 mg/L "
    "and NSE = \u22122.723 — the model is actively harmful, performing worse than the lake DO mean. "
    ...
    "(1.40 mg/L). "
    "The 3-seed ensemble LSTM achieves RMSE=0.300 mg/L (beating Ridge 0.303 mg/L) and KGE=0.932 vs Ridge KGE=0.908 \u2014 "
    ...
    "surpasses Ridge on every metric: RMSE 0.300 vs 0.303 mg/L, KGE 0.932 vs 0.908. "
    "While the single-site RMSE difference over Ridge is within bootstrap CI overlap, "
    "the Optuna LSTM demonstrates clearly superior KGE (0.932 vs 0.908), "
    ...
    "(Wilcoxon p=0.007), while per-gauge retraining shows consistent but not statistically "
...
story.append(p(
    ...
    "The river\u2192lake zero-shot failure (NSE = \u22122.723) is the strongest quantitative "
...
story.append(p(
    ...
    "better than Ridge (Wilcoxon p=0.007 across 11 gauges); per-gauge retraining improvement "
...
story.append(p(
    ...
    "The 3-seed ensemble LSTM achieves DO RMSE = 0.300 mg/L and KGE = 0.932 at the focus gauge "
    "(gauge 2473, Aare at Bern), beating Ridge on both RMSE (0.300 vs 0.303) and KGE (0.932 vs 0.908), "
...
story.append(p(
    ...
    "(RMSE = 2.811 mg/L, NSE = \u22122.723), confirming that river and lake DO dynamics are "
    ...
    "the Swiss-trained LSTM achieves a mean RMSE of 1.292 mg/L, with the Willamette River "
    "(Oregon) achieving 0.759 mg/L — approaching the lake benchmark — consistent with its "
...
changelog_data = [
    ...
    [p("1.16","table_cell_c"), p("05 May 2026","table_cell"),
     p("Full UBELIX rerun (jobs 3515515\u20133515836): corrected 3-seed ensemble (seeds 0/42/123 genuinely independent). "
       "All results updated from new run: LSTM best DO RMSE = 0.300 mg/L (KGE 0.932), "
       "zero-shot mean 0.419 mg/L (p=0.007), EA-LSTM 0.405 mg/L, "
       "USGS mean 1.292 mg/L (Willamette 0.759 mg/L), Swiss lake zero-shot 2.811 mg/L. "
    ...
    [p("1.14","table_cell_c"), p("03 May 2026","table_cell"),
     p("Added Section 5.7: Swiss Lake LSTM results (Bärenbold et al. 2026, 21 Swiss lakes). "
       "Zero-shot river\u2192lake transfer: RMSE = 2.811 mg/L, NSE = \u22122.723, KGE = \u22120.379 (fails). "
    ...
    [p("1.10","table_cell_c"), p("April 2026","table_cell"),
     p("Cross-continental zero-shot transfer to 4 US rivers (notebook 08); "
       "statistical significance confirmed for zero-shot LSTM vs Ridge (p=0.007); "
